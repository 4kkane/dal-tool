...
exports.generateGoFileFromSQL = generateGoFileFromSQL;
function sqlTypeToGoType(sqlType) {
    const t = sqlType.toLowerCase();
    if (t.includes('tinyint(1)'))
        return 'uint32';
    if (t.includes('int'))
        return 'int64';
...
function generateGoFileFromSQL(sql) {
...
//# sourceMappingURL=gendalfile.js.map